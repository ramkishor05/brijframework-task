...
public class TaskResourcesUtil {
	...
	public static RequestedTaskMeta getRequestedTask(ClassMeta owner, Method target) {
	...
	public static ScheduledTaskMeta getScheduledTask(ClassMeta owner, Method target) {
	...
	public static TaskMeta getSystemTask(ClassMeta owner, Method method) {
	...
	public static TaskMeta getAutoTask(ClassMeta owner, Method method) {
		Map<String, Object> map = AnnotationUtil.getAnnotationData(method, Task.class);
		TaskMeta setups = (TaskMeta) InstanceUtil.getInstance(TaskMeta.class, map);
	...
	public static TaskMeta getOnDemandTask(ClassMeta owner, Method method) {
		Map<String, Object> map = AnnotationUtil.getAnnotationData(method, Task.class);
		TaskMeta setups = (TaskMeta) InstanceUtil.getInstance(TaskMeta.class, map);
		setups.init(owner, method);
		return setups;
	...
	public static TaskMeta getDefualtTask(ClassMeta owner, Method method) {
		Map<String, Object> map = AnnotationUtil.getAnnotationData(method, Task.class);
		TaskMeta setups = (TaskMeta) InstanceUtil.getInstance(TaskMeta.class, map);
	...
	public static TaskMeta getScheduleTask(ClassMeta owner, Method method) {
		Map<String, Object> map = AnnotationUtil.getAnnotationData(method, Task.class);
		TaskMeta setups = (TaskMeta) InstanceUtil.getInstance(TaskMeta.class, map);
